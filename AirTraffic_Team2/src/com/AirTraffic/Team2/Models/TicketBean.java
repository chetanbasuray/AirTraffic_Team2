...
public class TicketBean {
  ...
  private List<PersonBean> passangers;
  ...
  /**
   * @return the passangers
   */
  public List<PersonBean> getPassangers() {
    return passangers;
  }

  /**
   * @param passangers the passangers to set
   */
  public void setPassangers(List<PersonBean> passangers) {
  ...
  /**
   * @param ticket_booking_date the ticket_booking_date to set
   */
  ...
  /**
   * @param ticket_pnr the ticket_pnr to set
   */
  ...
  /**
   * @param ticket_paymentType_id the ticket_paymentType_id to set
   */
  ...
  /**
   * @param ticket_bookingStatus_id the ticket_bookingStatus_id to set
   */
  ...
  /**
   * @param ticket_currency_id the ticket_currency_id to set
   */
  ...
  /**
   * @param ticket_counter_id the ticket_counter_id to set
   */
  ...
  /**
   * @param ticket_verificationTime the ticket_verificationTime to set
   */
